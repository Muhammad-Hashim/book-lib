   ...
   return (
    <div className="App"> 
     <form  className="form"action="submit ">
      <div>
         <input type="text" className='form_input ' placeholder='Search Name .........' value={value} onChange={(e) => setvalue(e.target.value)}/>
    ...
    <div>
      {
        data.map((person) => (
          <div className="Books" key={person._id}>
            ...
            <div>
              <h5>{person.title}</h5>
              <p className="author"><b>author:</b>{person.authors}</p>
              <p><b>categories:</b>{person.categories}</p>
            </div>
          </div>
        ))
      }
